...
%>
	<nav id="nav" class="mobileUI-site-nav">
		<ul>
			...
			<li class="current_page_item"><a href="library.jsp">Your library</a></li>
...
<%
    ...
    Query query = new Query("AudioRecord", recordKey).addSort("date", Query.SortDirection.DESCENDING);
    List<Entity> records;
...
<% if (isPageFilled == true) { %>			
	<div style="text-align: center">
		...
		%>
		<a href="http://localhost:8888/library.jsp?offset=<%= offset %>" class="button button-alt">Show older records</a>
	</div>
<% } %>
						</section>
					</div>							
