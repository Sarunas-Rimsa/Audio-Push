...
%>
	<div id="banner-wrapper">
		...
		<tr><td><h1>Title for your Audio:*</td>
			<td><input type="text" value="<%=record.getProperty("file_title")%>" name="file_title" placeholder="eg: 'My first guitar solo'" size="35" required/></td>
		</tr>
		<tr><td><h1>Subtitle: </h1></td>
			<td><input type="text" value="<%=record.getProperty("file_subtitle")%>" name="file_subtitle" placeholder="eg: 'Recorded while visiting my brother'" size="35" /></td>
		</tr>
		<tr><td><h1>Tags (comma separated): </h1></td>
			<td><input type="text" value="<%=printableTags%>" name="file_tags" placeholder="eg: 'rock, good-music, yolo'" size="35" /></td>
		</tr>
		<tr><td><h1>Short description: </h1></td>
			<td><textarea name="file_desc" rows="5" cols="28" placeholder="If you want to tell us why your record is so cool, please feel free to do it here!"><%=record.getProperty("file_desc")%></textarea></td>
		</tr>		
